 ...
 */
    ...
    (() => {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                if ("email" === formRequiredItem.dataset.required) {
                    ...
                    this.addError(formRequiredItem);
                    error++;
                } else if ("hash" === formRequiredItem.dataset.required) if (!this.containsHash(formRequiredItem.value)) {
                    this.addError(formRequiredItem);
                    error++;
        ...
        function initSliders() {
            if (document.querySelector(".highlights-swiper")) new core(".highlights-swiper", {
            ...
            if (document.querySelector(".highlights-video-swiper")) new core(".highlights-video-swiper", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
...
***************************************************************************** */
        ...
        function core_utils_isObject(obj) {
            ...
            return "object" === typeof obj && null != obj && "Object" === (null == obj ? void 0 : null == (_obj$constructor = obj.constructor) ? void 0 : _obj$constructor.name);
        }
        ...
        class HTMLMaskElement extends MaskElement {
            ...
            get rootElement() {
                ...
                return null != (_this$input$getRootNo = null == (_this$input$getRootNo2 = (_this$input = this.input).getRootNode) ? void 0 : _this$input$getRootNo2.call(_this$input)) ? _this$input$getRootNo : document;
            }
            get isActive() {
        ...
        class InputMask {
            constructor(el, opts) {
                this.el = el instanceof MaskElement ? el : el.isContentEditable && "INPUT" !== el.tagName && "TEXTAREA" !== el.tagName ? new HTMLContenteditableMaskElement(el) : new HTMLInputMaskElement(el);
            ...
            maskEquals(mask) {
                var _this$masked;
                return null == mask || (null == (_this$masked = this.masked) ? void 0 : _this$masked.maskEquals(mask));
            }
            get mask() {
        ...
        class Masked {
            ...
            totalInputPositions(fromPos, toPos) {
                if (void 0 === fromPos) fromPos = 0;
                if (void 0 === toPos) toPos = this.value.length;
            ...
            _appendChar(ch, flags, checkTail) {
                ...
                if (details.inserted) {
                    let consistentTail;
                    let appended = false !== this.doValidate(flags);
            ...
            append(str, flags, tail) {
                ...
                if (null != flags && flags.tail) flags._beforeTailState = this.state;
                let details;
                ...
                if ((true === this.eager || "append" === this.eager) && null != flags && flags.input && str) details.aggregate(this._appendEager());
            ...
            splice(start, deleteCount, inserted, removeDirection, flags) {
                if (void 0 === removeDirection) removeDirection = DIRECTION.NONE;
                if (void 0 === flags) flags = {
                    input: true
                };
                const tailPos = start + deleteCount;
                const tail = this.extractTail(tailPos);
                const eagerRemove = true === this.eager || "remove" === this.eager;
                let oldRawValue;
                if (eagerRemove) {
                ...
                if (removeDirection !== DIRECTION.NONE) {
                    startChangePos = this.nearestInputPos(start, deleteCount > 1 && 0 !== start && !eagerRemove ? DIRECTION.NONE : removeDirection);
        ...
        class ChunksTailDetails {
            ...
            extend(tailChunk) {
                ...
                const extendLast = lastChunk && (lastChunk.stop === tailChunk.stop || null == tailChunk.stop) && tailChunk.from === lastChunk.from + lastChunk.toString().length;
            ...
            unshift(beforePos) {
                ...
                const chunkShiftPos = null != beforePos ? beforePos - this.from : beforePos;
                let ci = 0;
        ...
        class PatternCursor {
            ...
            _pushLeft(fn) {
                this.pushState();
                for (this.bindBlock(); 0 <= this.index; --this.index, this.offset = (null == (_this$block = this.block) ? void 0 : _this$block.value.length) || 0) {
                    var _this$block;
        ...
        class PatternFixedDefinition {
            ...
            remove(fromPos, toPos) {
                if (void 0 === fromPos) fromPos = 0;
                if (void 0 === toPos) toPos = this._value.length;
                this._value = this._value.slice(0, fromPos) + this._value.slice(toPos);
                if (!this._value) this._isRawInput = false;
                return new ChangeDetails;
            }
            nearestInputPos(cursorPos, direction) {
                if (void 0 === direction) direction = DIRECTION.NONE;
                const minPos = 0;
            ...
            _appendChar(ch, flags) {
                ...
                const appendEager = true === this.eager || "append" === this.eager;
        ...
        class PatternInputDefinition {
            ...
            currentMaskFlags(flags) {
                ...
                return {
                    ...flags,
                    _beforeTailState: (null == flags ? void 0 : null == (_flags$_beforeTailSta = flags._beforeTailState) ? void 0 : _flags$_beforeTailSta.masked) || (null == flags ? void 0 : flags._beforeTailState)
                };
            }
        }
        ...
        class MaskedPattern extends Masked {
            constructor(opts) {
                super({
                    ...
                    ...opts,
                    definitions: Object.assign({}, PatternInputDefinition.DEFAULT_DEFINITIONS, null == opts ? void 0 : opts.definitions)
                });
            }
            updateOptions(opts) {
                super.updateOptions(opts);
            ...
            _rebuildMask() {
                ...
                for (let i = 0; i < pattern.length; ++i) {
                    if (this.blocks) {
                        ...
                        const bNames = Object.keys(this.blocks).filter((bName => 0 === p.indexOf(bName)));
            ...
            _appendEager() {
                ...
                const details = new ChangeDetails;
                let startBlockIndex = null == (_this$_mapPosToBlock = this._mapPosToBlock(this.value.length)) ? void 0 : _this$_mapPosToBlock.index;
            ...
            _appendCharRaw(ch, flags) {
                ...
                for (let bi = blockIter.index; ;++bi) {
                    ...
                    const blockDetails = block._appendChar(ch, {
                        ...flags,
                        _beforeTailState: null == (_flags$_beforeTailSta = flags._beforeTailState) ? void 0 : null == (_flags$_beforeTailSta2 = _flags$_beforeTailSta._blocks) ? void 0 : _flags$_beforeTailSta2[bi]
                    });
            ...
            _appendPlaceholder(toBlockIndex) {
                ...
                const endBlockIndex = null != toBlockIndex ? toBlockIndex : this._blocks.length;
                this._blocks.slice(startBlockIndex, endBlockIndex).forEach((b => {
                    if (!b.lazy || null != toBlockIndex) {
                        var _blocks2;
                        const bDetails = b._appendPlaceholder(null == (_blocks2 = b._blocks) ? void 0 : _blocks2.length);
        ...
        class MaskedDate extends MaskedPattern {
            ...
            doValidate(flags) {
                ...
                return super.doValidate(flags) && (!this.isComplete || this.isDateExist(this.value) && null != date && (null == this.min || this.min <= date) && (null == this.max || date <= this.max));
            }
            isDateExist(str) {
        ...
        class MaskedDynamic extends Masked {
            ...
            _update(opts) {
                super._update(opts);
                if ("mask" in opts) this.compiledMasks = Array.isArray(opts.mask) ? opts.mask.map((m => createMask({
            ...
            _applyDispatch(appended, flags, tail) {
                if (void 0 === appended) appended = "";
                if (void 0 === flags) flags = {};
                if (void 0 === tail) tail = "";
                const prevValueBeforeTail = flags.tail && null != flags._beforeTailState ? flags._beforeTailState._value : this.value;
                const inputValue = this.rawInputValue;
                const insertValue = flags.tail && null != flags._beforeTailState ? flags._beforeTailState._rawInputValue : inputValue;
                const tailValue = inputValue.slice(insertValue.length);
                const prevMask = this.currentMask;
                const details = new ChangeDetails;
                const prevMaskState = null == prevMask ? void 0 : prevMask.state;
            ...
            currentMaskFlags(flags) {
                ...
                return {
                    ...flags,
                    _beforeTailState: (null == (_flags$_beforeTailSta = flags._beforeTailState) ? void 0 : _flags$_beforeTailSta.currentMaskRef) === this.currentMask && (null == (_flags$_beforeTailSta2 = flags._beforeTailState) ? void 0 : _flags$_beforeTailSta2.currentMask) || flags._beforeTailState
                };
            }
            ...
            reset() {
                ...
                null == (_this$currentMask = this.currentMask) ? void 0 : _this$currentMask.reset();
            ...
            get isComplete() {
                ...
                return Boolean(null == (_this$currentMask2 = this.currentMask) ? void 0 : _this$currentMask2.isComplete);
            }
            get isFilled() {
                var _this$currentMask3;
                return Boolean(null == (_this$currentMask3 = this.currentMask) ? void 0 : _this$currentMask3.isFilled);
            }
            remove(fromPos, toPos) {
                const details = new ChangeDetails;
            ...
            get state() {
                ...
                return {
                    ...
                    currentMask: null == (_this$currentMask4 = this.currentMask) ? void 0 : _this$currentMask4.state
                };
            }
            set state(state) {
            ...
            typedValueEquals(value) {
                ...
                return Boolean(null == (_this$currentMask5 = this.currentMask) ? void 0 : _this$currentMask5.typedValueEquals(value));
            }
        }
        ...
        class MaskedNumber extends Masked {
            ...
            _separatorsCount(to, extendOnSeparators) {
                if (void 0 === extendOnSeparators) extendOnSeparators = false;
                let count = 0;
            ...
            _separatorsCountFromSlice(slice) {
                if (void 0 === slice) slice = this._value;
            ...
            doSkipInvalid(ch, flags, checkTail) {
                if (void 0 === flags) flags = {};
                const dropFractional = 0 === this.scale && ch !== this.thousandsSeparator && (ch === this.radix || ch === MaskedNumber.UNMASKED_RADIX || this.mapToRadix.includes(ch));
            ...
            typedValueEquals(value) {
                return (super.typedValueEquals(value) || MaskedNumber.EMPTY_VALUES.includes(value) && MaskedNumber.EMPTY_VALUES.includes(this.typedValue)) && !(0 === value && "" === this.value);
            }
        }
        ...
        function createPipe(arg, from, to) {
            if (void 0 === from) from = PIPE_TYPE.MASKED;
            if (void 0 === to) to = PIPE_TYPE.MASKED;
        ...
        function formInput() {
            ...
            labels.forEach((label => {
                label.innerHTML = label.innerText.split("").map(((letter, index) => `<span style="transition-delay:${20 * index}ms">${letter}</span>`)).join("");
            }));
        }
        formInput();
        if ("UACOD: Україномовна спільнота Call of Duty: Warzone та Warzone 2 Discord UA" === document.title) {
            ...
            if (isChromeiOS) {
                ...
                for (let i = 0; i < slideImages.length; i++) slideImages[i].style.maxWidth = "85%";
            }
        }
        if ("UACOD - Tournament" === document.title) {
